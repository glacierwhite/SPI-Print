...
To implement SPI-Print, you need to (1) first train the three embedding extractors and (2) then train the super-resolution model. Detailed training and evaluation instructions can be found in the **README.md** file of each subfolder.